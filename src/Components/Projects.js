...
const slideData = [
    {
      ...
      link2:"",
      src: 'https://images.unsplash.com/photo-1610981755415-3f7c9202cccb?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80'},
    ...
    class Slide extends React.Component {
      ...
      render() {
        const { src, button, button2,headline, index, link1, link2 } = this.props.slide;
        ...
        return /*#__PURE__*/(
          ...
          React.createElement("a", { className: "slide__action btn", href:link1}, button),
          React.createElement("a", { className: "slide__action btn", href:link2}, button2)
          )));
...
export default function Projects(){
  let { id } = useParams
        return(
            <>{id}
            <div id="Projects" className="ProjectDiv" style={{padding:"7rem",overflowX:'hidden', justifyContent:'center',alignSelf:'center',display:'flex'}}>
            <h1>PROJECTS</h1>
